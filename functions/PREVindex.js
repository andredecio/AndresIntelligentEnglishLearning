...
const vocabularySchema = Schema.array({
    items: Schema.object({
        properties: {
            ...
            items: Schema.array({
                items: Schema.object({
                    ...
                    required: ["TITLE", "CEFR", "DESCRIPTION", "THEME", "MODULETYPE", "WORD_TYPE", "imagePrompt"], 
        ...
        required: ["TITLE", "CEFR", "DESCRIPTION", "THEME", "MODULETYPE", "WORD_TYPE"], 
    ...
    try {
        ...
        **Module Types and Their Specific Fields:**
        ...
        1.  **VOCABULARY_GROUP** (for words with multiple distinct meanings ):
            ...
            - "DESCRIPTION": This must be a brief description of the word's origins and components (e.g., prefixes) if any.
        ...
        **Crucial Rules for Generation:**
        ...
        [
          ...
          },
          {
            ...
            "MODULETYPE": "VOCABULARY_GROUP",
            "CEFR": "A1",
            "DESCRIPTION": "Origin from Old English...",
			"THEME": "General English"
	
            "items": [
              {
                "TITLE": "set (meaning: to place)",
                "MODULETYPE": "VOCABULARY",
                "CEFR": "A1",
